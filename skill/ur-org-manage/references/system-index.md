...
> 路径前缀 `/api/v1/system/` 下的所有 group。如需查看某个 group 的详细端点，调用 `skill_view(name="ur-api", filePath="references/groups/{group文件名}.md")`。
...
| `system/job/task` | 14 | `references/groups/system-job-task.md` |
| `system/log` | 2 | `references/groups/system-log.md` |
...
| `system/notify/news` | 5 | `references/groups/system-notify-news.md` |
...
| `system/tenant/config` | 2 | `references/groups/system-tenant-config.md` |
| `system/tenant/core` | 2 | `references/groups/system-tenant-core.md` |
| `system/tenant/info` | 6 | `references/groups/system-tenant-info.md` |
| `system/tenant/renewal` | 3 | `references/groups/system-tenant-renewal.md` |
| `system/tenant/user` | 11 | `references/groups/system-tenant-user.md` |
| `system/tenant/user/role` | 2 | `references/groups/system-tenant-user-role.md` |
