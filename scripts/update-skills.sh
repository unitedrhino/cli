...
if [ -z "$SKILLS_REPO" ]; then
  ...
  # 复制子 skill
  for sub in ur-device ur-device-analytics ur-device-debug ur-product ur-project ur-user ur-system ur-tenant ur-ai scene-linkage thing-model protocol-script; do
