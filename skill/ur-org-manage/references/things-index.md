...
> 路径前缀 `/api/v1/things/` 下的所有 group。如需查看某个 group 的详细端点，调用 `skill_view(name="ur-api", filePath="references/groups/{group文件名}.md")`。
...
| `things/device/edge` | 2 | `references/groups/things-device-edge.md` |
...
| `things/group/device` | 3 | `references/groups/things-group-device.md` |
| `things/group/info` | 5 | `references/groups/things-group-info.md` |
| `things/hook` | 1 | `references/groups/things-hook.md` |
| `things/ota/firmware/device` | 4 | `references/groups/things-ota-firmware-device.md` |
| `things/ota/firmware/info` | 5 | `references/groups/things-ota-firmware-info.md` |
| `things/ota/firmware/job` | 4 | `references/groups/things-ota-firmware-job.md` |
| `things/ota/module/info` | 5 | `references/groups/things-ota-module-info.md` |
| `things/product/category` | 11 | `references/groups/things-product-category.md` |
| `things/product/config` | 1 | `references/groups/things-product-config.md` |
| `things/product/custom` | 2 | `references/groups/things-product-custom.md` |
| `things/product/info` | 8 | `references/groups/things-product-info.md` |
| `things/product/remoteConfig` | 4 | `references/groups/things-product-remoteConfig.md` |
| `things/product/schema` | 7 | `references/groups/things-product-schema.md` |
| `things/project/crud` | 3 | `references/groups/things-project-crud.md` |
| `things/project/customData` | 2 | `references/groups/things-project-customData.md` |
| `things/project/info` | 5 | `references/groups/things-project-info.md` |
| `things/project/profile` | 3 | `references/groups/things-project-profile.md` |
| `things/protocol/config` | 5 | `references/groups/things-protocol-config.md` |
| `things/protocol/container` | 5 | `references/groups/things-protocol-container.md` |
| `things/protocol/image` | 1 | `references/groups/things-protocol-image.md` |
| `things/protocol/info` | 5 | `references/groups/things-protocol-info.md` |
| `things/protocol/script` | 8 | `references/groups/things-protocol-script.md` |
...
| `things/scene/log` | 1 | `references/groups/things-scene-log.md` |
